...
const ContactMe = () => {
  return (
    ...
    <div className=' bg-white shadow font-serif mt-5'>
      ...
      <div className="flex flex-col items-center w-full my-5">
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
          <div className="flex flex-wrap items-center justify-center gap-5 lg:gap-12 gap-y-3 lg:flex-nowrap text-dark-grey-900">
            <a href="" className=" hover:text-[#9F6A69]">About Me</a>
            <a href="#" className=" hover:text-[#9F6A69]">Education</a>
            <a href="#" className=" hover:text-[#9F6A69]">Experience</a>
            <a href="#" className=" hover:text-[#9F6A69]">Projects</a>
            <a href="#" className=" hover:text-[#9F6A69]">Services</a>
          </div>
          <p className="text-3xl text-[#744d4c] m-10">Keep in touch</p>
          <div className="flex items-center gap-8">
            ...
            <a href="#" className="text-grey-700 hover:text-grey-900"><img src={Email} className="size-6"/></a>
          </div>
        </div>
