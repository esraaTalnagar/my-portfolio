      ...
      <div className="flex flex-col items-center w-full my-5">
        ...
        <div className="flex flex-col items-center gap-6 mb-8">
          ...
          <div className="flex items-center gap-8">
            <a href="https://www.github.com/esraaTalnagar" className="text-grey-700 hover:text-grey-900">
            ...
            <a href="https://www.linkedin.com/in/esraa-alnaagr-3105b333a" className="text-grey-700 hover:text-grey-900">
