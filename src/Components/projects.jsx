...
import FifthProj from '../assets/GameReview.png'
    ...
    <div className="py-10 bg-[#f1e6e3] shadow-inner shadow-slate-300">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-center gap-8">
          <div class="hover:scale-105 transition-transform relative flex w-full sm:w-[45%] lg:w-[30%] max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
          ...
          <div class="hover:scale-105 transition-transform relative flex w-full sm:w-[45%] lg:w-[30%] max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
            <div class="relative mx-4 mt-4 overflow-hidden text-white shadow-lg rounded-xl bg-blue-gray-500 bg-clip-border shadow-blue-gray-500/40">
              <img src={FifthProj} alt="ui/ux review check" />
              <div class="absolute inset-0 w-full h-full to-bg-black-10 bg-gradient-to-tr from-transparent via-transparent to-black/60"></div>
            </div>
            <div class="p-6">
              <div class="flex items-center justify-between mb-3">
              ...
              <p class="block font-sans text-base antialiased font-light leading-relaxed text-gray-700">
                An interactive platform for browsing and reviewing video games.
                Built with HTML, CSS, and JavaScript, it fetches real-time data
                from an external API. Features include search, filtering by
                genre, and a responsive design, offering a seamless user
                experience across devices.
              </p>
              <div className="inline-flex flex-wrap items-center gap-3 mt-8 group">
                <a
                  href="https://github.com/esraaTalnagar/GamesReview"
                  className="text-grey-700 hover:text-[#9F6A69]"
                  target="_blank"
                >
                  <svg
                ...
                <a
                  href="https://esraatalnagar.github.io/GamesReview/"
                  className="text-grey-700 hover:text-[#9F6A69]"
                  target="_blank"
                >
                  <svg
